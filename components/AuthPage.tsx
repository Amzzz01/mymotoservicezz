    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 p-4 font-sans">
        ...
        <div className="w-full max-w-sm bg-slate-800 p-6 sm:p-8 rounded-lg shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2">
                    <button type="submit" className="w-full bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold py-2 px-4 rounded-md shadow-md shadow-cyan-500/20 transition-colors">
